...
@interface LiveRoomViewController () <AgoraRtcEngineDelegate, FUCameraDelegate, FUAPIDemoBarDelegate>
...
- (void)viewDidLoad {
    ...
    if (self.isBroadcaster) {
        ...
        [self loadFaceUnityTools];
    }
}

- (void)loadFaceUnityTools {
    ...
    [self.glView addSubview:self.demoBar];
}
...
- (void)updateButtonsVisiablity {
    ...
    self.broadcastButton.hidden = !self.isBroadcaster;
...
- (void)loadAgoraKit {
    ...
    if (self.isBroadcaster) {
        ...
        [self.rtcEngine setVideoProfile:AgoraVideoProfilePortrait360P swapWidthAndHeight:YES];
